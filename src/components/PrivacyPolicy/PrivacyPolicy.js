  ...
  return (
    <div>
      ...
      <div className={style.cardContainer}>
        ...
        <p>
          El presente Política de Privacidad establece los términos en que A
          Sala Llena usa y protege la información que es proporcionada por sus
        ...
        <p>
          A Sala Llena está altamente comprometido para cumplir con el
        ...
        <p>
          A Sala Llena Se reserva el derecho de cambiar los términos de la
